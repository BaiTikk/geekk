...
//
// function setModal() {
//     let model = document.createElement('button')  ///button
//     model.setAttribute('class', 'modal')
//     document.body.append(model)
//
//
//     model.innerText = 'restart'
...
//
//
//     // let clouse = document.createElement('button')
//     // clouse.setAttribute('class','closee')
//     // document.body.append(clouse)
//     //
//     // clouse.innerText = 'close'
